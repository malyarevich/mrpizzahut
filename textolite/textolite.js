                ...
                br = function(a) {
                    ...
                    if (bq.c && bq.c.length) bq(bq.c.shift());
                        ...
                        switch (bq.f) {
                            case 0:
                            {
                                bc.innerHTML = bc.getAttribute('data-uploading-complete');bc.className = 'textolite-success';
                                break;
                            }
                            case 1:
                            {
                                bc.innerHTML = bc.getAttribute('data-no-response');bc.className = 'textolite-error';
                                break;
                            }
                            case 2:
                            {
                                bc.innerHTML = bc.getAttribute('data-uploading-error');bc.className = 'textolite-error';
                                break;
                            }
                            case 3:
                            {
                                bc.innerHTML = bc.getAttribute('data-extension-error');bc.className = 'textolite-error';
                                break;
                            }
                        }
                        delete bq.f;
